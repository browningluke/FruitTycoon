...
| Users can only harvest once a set time period has elapsed.                   | ![image001](meeting-success-criteria/image001.png)<br/>Successful.                                                                                                                                                                                                                                    |
| Raw materials can be refined into higher level goods.                        | ![image003](meeting-success-criteria/image003.png)<br/>Successful.                                                                                                                                                                                                                                    |
| Users can send, accept and decline trades to/from other users.               | Sender player<br/>![image005](meeting-success-criteria/image005.png)<br/>Recipient Player<br/>![image007](meeting-success-criteria/image007.png)<br/>Accept<br/>![image009](meeting-success-criteria/image009.png)<br/>Decline<br/>![image011](meeting-success-criteria/image011.png)<br/>Successful. |
| User’s multipliers can be upgraded with an increasing cost.                  | Shop window before upgrade<br/>![image013](meeting-success-criteria/image013.png)<br/>Shop window after upgrade. Price of next multiplier upgrade has increased.<br/>![image015](meeting-success-criteria/image015.png)<br/>Successful.                                                               |
| Game posts leaderboard to server at specific time or when user runs command. | ![image017](meeting-success-criteria/image017.png)<br/>Successful.                                                                                                                                                                                                                                    |
| Game help message contains detailed information about each command.          | ![image019](meeting-success-criteria/image019.png)<br/>Successful.                                                                                                                                                                                                                                    |
